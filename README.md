...
The MCP server exposes 24 tools for reads and writes. See [`docs/mcp-connector.md`](docs/mcp-connector.md) for the full list.
...
job-squire/
  app/
    ...
    mcp_server.py     Remote MCP server (OAuth 2.0/PKCE, 24 tools)
