...
discussions, and any other Job Squire community forum), and also applies when
...
[@dellipse](https://github.com/dellipse) on GitHub. If the report concerns a
security-sensitive matter instead, use the private disclosure process in
